...
namespace MyInterviewQuestions.WebApi.Providers
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        private readonly string _publicClientId;
        //private readonly ApplicationUserManager _userManager = DependencyResolver.Current.GetService<ApplicationUserManager>();
